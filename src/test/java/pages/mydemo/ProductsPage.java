...
public class ProductsPage {
    ...
    public void addFirstProductToCart() {
        ...
        try {
            ...
            // Cross-platform: <project-root>/page-dumps/product-detail-dump.xml
            File dumpDir = new File("page-dumps");
            dumpDir.mkdirs();
            try (FileWriter fw = new FileWriter(new File(dumpDir, "product-detail-dump.xml"))) {
                fw.write(src);
            }

...
public class MyDemoBaseTest {
    ...
    private void setupLocal() throws Exception {
        // Cross-platform: resolves to <project-root>/apks/MyDemoApp.apk on any OS.
        // Drop the APK there if you want a fresh install; otherwise noReset just
        // launches whatever is already installed on the device/emulator.
        String apkPath = new java.io.File("apks/MyDemoApp.apk").getAbsolutePath();
